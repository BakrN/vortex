...
class Vvortex_afu_shim_VX_mem_bus_if__D40_T5 final : public VerilatedModule {
  public:

    // DESIGN SPECIFIC STATE
    VlWide<19>/*607:0*/ __PVT__req_data;

    // INTERNAL VARIABLES
    Vvortex_afu_shim__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vvortex_afu_shim_VX_mem_bus_if__D40_T5(Vvortex_afu_shim__Syms* symsp, const char* name);
